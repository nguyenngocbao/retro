  ...
  return (
    <section
      className={mergeClasses(
        `relative flex h-[500px] flex-col justify-end bg-join-the-world bg-cover bg-center text-center md:h-[400px] lg:bg-join-the-world-pc 2xl:h-[700px]`,
        className
      )}
      {...props}
    >
      ...
      <div className="absolute top-[50%] z-20 w-full translate-y-[-50%] px-[8px] py-[94px] md:px-[19px] lg:left-[50%] lg:mx-auto lg:max-w-[733px] lg:translate-x-[-50%] lg:p-0">
