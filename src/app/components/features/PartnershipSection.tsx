...
export const PartnershipSection = () => {
  return (
    <section className="relative mt-[130px] flex flex-col items-start justify-center gap-[39px] px-[19px] md:items-center 2xl:mt-[300px] 2xl:gap-[78px]">
      <div className="absolute bottom-[1px] left-0 z-10 h-[241px] w-full translate-y-[100%] bg-[linear-gradient(360deg,_rgba(38,_38,_38,_0.00)_0%,_rgba(38,_38,_38,_0.87)_37.79%,_#262626_100%)] 2xl:h-[421px] 2xl:bg-[linear-gradient(360deg,_rgba(38,_38,_38,_0.00)_0%,_rgba(38,_38,_38,_0.87)_52.08%,_#262626_100%)]"></div>
